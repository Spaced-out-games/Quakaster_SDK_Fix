...
namespace qk::EventCallbacks {
	...
	void QK_API on_textinput(GLFWwindow* window, int codepoint);
	...
	void QK_API on_joystick_connect(GLFWwindow* window, int jid, int event);
	void QK_API on_monitor_event(GLFWwindow* window, int event);
