...
namespace qkg
{
    ...
    ShaderSources load_shader(const std::string& path, const GLenum type)
    {
        return ShaderSources();
    }

    GLuint compile_shader(ShaderSources& shader)
    {
    ...
    inline void ShaderSources::attach_shader(GLenum type, const std::string& source)
    {
